...
(@u_admin, 'admin@gmail.com', 'Admin', '$2b$10$sZz.Z83PSBApYPJGmytZv.tETKhTtFm9pAdUL5w2CqH7DkkoTerQm', '0999888777', 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c', 'MALE', @r_admin, @b1, NOW(), NOW(), 'system', 'system'),
...
(@promo6, 'HALLOWEEN20', 'Đêm hội hóa trang Halloween', 'Giảm giá 20% cho tất cả các booking trong tuần lễ hội Halloween từ 25/10 đến 31/10', 'https://images.unsplash.com/photo-1509248961158-e54f6934749c?w=600&auto=format&fit=crop', 20, 100, 0, '2026-10-25 00:00:00', '2026-10-31 23:59:59', 1, NOW(), NOW(), 'system', 'system'),
...
(@promo10, 'BEERFEST10', 'Lễ hội bia tuyết sảng khoái', 'Giảm 10% cho thực đơn các loại bia lạnh hảo hạng khi đặt kèm món nhậu đặc sản cuối tuần', 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=600&auto=format&fit=crop', 10, 400, 0, '2026-05-01 00:00:00', '2026-09-30 23:59:59', 1, NOW(), NOW(), 'system', 'system');
...
(UUID(), 'Lễ Hội Ẩm Thực Bia Tuyết Thượng Hạng Cuối Tuần', 'Giải nhiệt mùa hè cực sảng khoái với lễ hội bia tuyết, giảm 10% các loại bia lạnh thượng hạng cùng thực đơn mồi nhắm phong phú!', 'PROMOTION', 'GLOBAL', 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=600&auto=format&fit=crop', 0, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 5 MINUTE), NULL);
